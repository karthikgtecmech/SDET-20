...
public static void main(String[] args) throws IOException, InterruptedException {
		...
		FileInputStream commonData = new FileInputStream("./data/commonData.properties");
		Properties data = new Properties();
		data.load(commonData);
		...
		String OppName = row4.getCell(2).getStringCellValue();
